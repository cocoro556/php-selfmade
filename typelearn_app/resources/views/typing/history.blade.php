...
<div class="flex flex-col items-center justify-center min-h-screen mb-10">
    ...
    <div class="w-full max-w-3xl flex flex-col gap-6">
        <div
            class="rounded-lg border border-white/10 bg-slate-900/70 text-gray-200"
        >
            <div class="px-6 py-3 border-b border-white/10 font-semibold">
                最近の練習結果
            </div>
            <div class="px-6 py-4">
                ...
                <div
                    class="grid grid-cols-7 items-center text-sm py-1 border-t border-white/5"
                >
                    <div>{{ optional($s->ts)->format('Y/m/d H:i') }}</div>
                    ...
                    <div class="text-center">
                        {{ $s->total ? round(($s->correct / $s->total) * 100) : 0
                        }}%
                    </div>
