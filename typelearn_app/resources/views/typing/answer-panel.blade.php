...
<div class="flex flex-col items-center justify-center min-h-screen">
    ...
    >
        <div class="flex justify-between items-center mb-2">
            ...
            <div class="text-xs tracking-widest text-gray-400">
                難易度: @switch($question->difficulty) @case('easy') 初級 @break
                @case('medium') 中級 @break @case('hard') 上級 @break @default
                未分類 @endswitch
            </div>
        </div>
    ...
    >
        ...
        <input
            type="hidden"
            id="is-my"
            value="{{ Route::currentRouteName() === 'typing.answer-panel-my' ? 1 : 0 }}"
        />
