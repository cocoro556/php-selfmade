...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Question::create([
            'category_id' => $categories['CSS'],
            'content' => 'CSSでテキストを中央寄せにするプロパティは？',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptで条件分岐を書くキーワードは？',
            'correct_answer' => 'if',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptでループを書くキーワードは？',
            'correct_answer' => 'for',
            'hint' => '繰り返し処理を書きます',
            'difficulty' => 'easy',
        ]);
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptでイベントリスナーを追加する方法は？',
        ...
        Question::create([
            'category_id' => $categories['CSS'],
            'content' => 'CSSで要素を絶対位置に配置するプロパティは？',
        ...
        Question::create([
            'category_id' => $categories['CSS'],
            'content' => 'CSSで要素を相対位置に配置するプロパティは？',
        ...
        Question::create([
            'category_id' => $categories['CSS'],
            'content' => 'CSSで要素を固定位置に配置するプロパティは？',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptでオブジェクトを作成する記号は？',
            'correct_answer' => '{}',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptで配列の要素を追加するメソッドは？',
            'correct_answer' => 'push',
            'hint' => '配列の末尾に要素を追加します',
            'difficulty' => 'medium',
        ]);
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptで配列の要素を削除するメソッドは？',
            'correct_answer' => 'pop',
            'hint' => '配列の末尾の要素を削除します',
            'difficulty' => 'medium',
        ]);
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptで文字列を分割するメソッドは？',
        ...
        Question::create([
            'category_id' => $categories['Python'],
            'content' => 'Pythonでファイルの存在を確認する関数は？',
        ...
        Question::create([
            'category_id' => $categories['HTML'],
            'content' => 'HTMLでセマンティックなマークアップをする際の主要なタグは？',
        ...
        Question::create([
            'category_id' => $categories['CSS'],
            'content' => 'CSSでレスポンシブデザインを実現するメディアクエリは？',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptでPromiseを使った非同期処理の書き方は？',
        ...
        Question::create([
            'category_id' => $categories['PHP'],
            'content' => 'PHPでPDOを使ったデータベース接続の書き方は？',
        ...
        Question::create([
            'category_id' => $categories['SQL'],
            'content' => 'SQLでサブクエリを使った複雑なクエリの例は？',
        ...
        Question::create([
            'category_id' => $categories['HTML'],
            'content' => 'HTMLでアクセシビリティを向上させるaria属性の例は？',
        ...
        Question::create([
            'category_id' => $categories['CSS'],
            'content' => 'CSSでアニメーションを作成するプロパティは？',
        ...
        Question::create([
            'category_id' => $categories['CSS'],
            'content' => 'CSSでグリッドレイアウトを作成するプロパティは？',
        ...
        Question::create([
            'category_id' => $categories['CSS'],
            'content' => 'CSSでフレックスボックスレイアウトを作成するプロパティは？',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptでasync/awaitを使った非同期処理の書き方は？',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptでクラスを定義するキーワードは？',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptでモジュールを読み込む構文は？',
        ...
        Question::create([
            'category_id' => $categories['JavaScript'],
            'content' => 'JavaScriptでモジュールをエクスポートする構文は？',
        ...
        Question::create([
            'category_id' => $categories['PHP'],
            'content' => 'PHPでインターフェースを定義するキーワードは？',
        ...
        Question::create([
            'category_id' => $categories['SQL'],
            'content' => 'SQLでストアドプロシージャを作成する命令は？',
        ...
        Question::create([
            'category_id' => $categories['Python'],
            'content' => 'Pythonでジェネレータを定義するキーワードは？',
        ...
        Question::create([
            'category_id' => $categories['Python'],
            'content' => 'Pythonでコンテキストマネージャーを作成するキーワードは？',
            'correct_answer' => 'with',
            'hint' => 'リソースの自動管理を行います',
            'difficulty' => 'hard',
        ]);
        ...
        Question::create([
            'category_id' => $categories['Python'],
            'content' => 'Pythonでメタクラスを定義するキーワードは？',
        ...
        Question::create([
            'category_id' => $categories['Python'],
            'content' => 'Pythonでプロパティを定義するデコレータは？',
